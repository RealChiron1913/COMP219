...
parser.add_argument('--batch-size', type=int, default=16, metavar='N',
                    help='input batch size for training (default: 128) 16')
parser.add_argument('--test-batch-size', type=int, default=32, metavar='N',
                    help='input batch size for testing (default: 128) 32')
...
def train_model():
    ...
    torch.save(model.state_dict(), str("16_32_epoch100_0.08") + '.pt')
    return model
